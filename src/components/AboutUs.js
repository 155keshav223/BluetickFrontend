...
const AboutUs = () => {
  return (
    <div className="about-us-container">
      <h1 style={{color: "lightblue"}} >What we offer</h1>

      <div className="offer-item">
        <h2 style={{color: "yellow"}}>Explore AI Opportunities for Your Enterprise</h2>
        <p>
      ...
      <div className="offer-item">
        <h2 style={{color: "yellow"}}>Design AI Trust Layer</h2>
        <p>
      ...
      <div className="offer-item">
        <h2 style={{color: "yellow"}}>Scalability-Focused Solutions</h2>
        <p>
      ...
      <div className="offer-item">
        <h2 style={{color: "yellow"}}>End to end Workflow automation</h2>
        <p>
